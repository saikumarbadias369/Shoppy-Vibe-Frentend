...
export default function Product() {
  ...
  const emptyResults = () => {
    // console.log("product.products.products.content?.length>"+product.products.products.content?.length)
    return (
  ...
  const renderTheProducts = () => {
    return (
      <>      {
        product.products?.products?.content?.length ? <div className="lg:col-span-5">
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-20">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-6">
              ...
              {/* Product grid */}
              {
                product.products.isLoading ? renderLoadingView() : renderTheProducts()
              }
